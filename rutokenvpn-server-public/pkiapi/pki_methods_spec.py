"""
Common PKI methods text
"""
import unittest
from init_pki import init_folder_structure
from executables_path import EXEC_PATHS
from pki_methods import generate_req, create_serial, sign_req, \
    sign_req_with_ca, gen_crl, revoke, gen_diffie_hellman
...
class TestPkiMethods(unittest.TestCase):
    ...
    def test_03_generate_ca_req(self):
        result = generate_req(
            self.evp_pkey_type, #pylint: disable=no-member
