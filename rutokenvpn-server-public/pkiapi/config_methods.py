...
from .executables_path import EXEC_PATHS # pylint: disable=unused-import
...
def create_client_config(pkey_type, remote_server, ca_cert_path, dh_key_path, ta_key_path,
                        client_cert_path = None, client_key_path = None,
                        ldap_base_dn = None, server_dns = None):
